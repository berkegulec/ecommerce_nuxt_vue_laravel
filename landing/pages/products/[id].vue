<template>
  <PageContent
    title="Bora Armchair"
    :second-link="{ name: 'Products', uri: '/products' }"
  >
    <div
              ...
              <div class="product-info col-lg-5 col-md-12 col-12">
                ...
                <div class="product-meta">
                  <span class="sku-wrapper"
                    >SKU: <span class="sku">D2300-3-2-2</span></span
                  >
                  <span class="posted-in"
                    >Category:
                    <a href="shop-grid-left.html" rel="tag">Furniture</a></span
                  >
                  <span class="tagged-as"
                    >Tags: <a href="shop-grid-left.html" rel="tag">Hot</a>,
                    <a href="shop-grid-left.html" rel="tag">Trend</a></span
                  >
                </div>
...
<script setup>
import ProductMainImageCarousel from "~~/components/Product/ProductMainImageCarousel.vue";
