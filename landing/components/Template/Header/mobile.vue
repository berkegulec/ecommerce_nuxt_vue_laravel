<template>
  <div class="header-mobile">
                  ...
                  <div class="cart-empty-wrap">
                    <ul class="cart-list">
                      <li class="empty">
                        ...
                        <a class="go-shop" href="shop-grid-left.html">GO TO SHOP<i aria-hidden="true"
                  ...
                  <div class="cart-list-wrap">
                    <ul class="cart-list">
                      <li class="mini-cart-item">
                        ...
                        <a href="shop-details.html" class="product-image"><img width="600" height="600"
    ...
    <div class="header-mobile-fixed">
      <!-- Shop -->
      <div class="shop-page">
        <NuxtLink to="/products"><i class="wpb-icon-shop"></i></NuxtLink>
      </div>

      <!-- Login -->
      <div class="my-account">
        <div class="login-header">
          <NuxtLink to="/login"><i class="wpb-icon-user"></i></NuxtLink>
        </div>
      </div>
