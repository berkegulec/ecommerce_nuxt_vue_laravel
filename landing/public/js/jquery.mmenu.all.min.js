        ...
        C.on("panstart", function (e) {
          ...
          .on(u.events, function (e) {
            if (
              ...
              u.negative && (r = -r),
              r != b && (v = r >= b ? u.open_dir : u.close_dir),
              (b = r),
              b > n.threshold && 1 == p)
            ) {
              ...
              (p = 2),
                ...
                (g = t(s.$wndw[m]() * i[m].perc, i[m].min, i[m].max));
            }
            2 == p &&
              ((l =
                t(b, 10, g) - ("front" == f.opts.offCanvas.zposition ? g : 0)),
              u.negative && (l = -l),
          ...
          .on("panend", function (e) {
            2 == p &&
              ...
              f[v == u.open_dir ? "_openFinish" : "close"]()),
              (p = 0);
          });
      }
      function i(e, t, n, i) {
              ...
              var h = function (e, t) {
                  ...
                  return (
                    "after" == v
                      ? ((y = "x" == e ? b : g),
                        (w = _ - (y + C)),
                        (n[h] = y + d.offset.button[e]),
                        (n[f] = "auto"),
                        s.push(i["x" == e ? "tipleft" : "tiptop"]))
                      : ((y = "x" == e ? g : b),
                        (w = y - C),
                        (n[f] =
                          "calc( 100% - " + (y - d.offset.button[e]) + "px )"),
                        (n[h] = "auto"),
        ...
        setup: function () {
          if (this.opts.offCanvas) {
            ...
            var a = function (e) {
              ...
              this.__refactorClass(e.find("." + t), t, "slideout")[
                s.elemInsertMethod
              ](s.elemInsertSelector);
            };
        ...
        setup: function () {
          ...
          if (
            ...
            var r = e(
              ...
              d = e(
                '<button class="' + a.tabend + '" tabindex="0" type="button" />'
              );
            this.bind("initMenu:after", function () {
            ...
            s.load &&
              ...
              this.bind("initOpened:before", function () {
                var e = this.$pnls
                  ...
                  .closest("." + i.lazysubmenu);
                e.length && this.initPanels(e);
              }),
              this.bind("openPanel:before", function (e) {
                ($panels = this.__findAddBack(e, "." + i.lazysubmenu).not(
                  ...
                  this.$menu.find("." + s.search).each(function () {
                    ...
                    y.length &&
                      u.on(o.keyup + "-" + i, function (e) {
                        y[u.val().length ? "removeClass" : "addClass"](
                          s.hidden
                        );
                      }),
                      u.trigger(o.keyup + "-" + i);
