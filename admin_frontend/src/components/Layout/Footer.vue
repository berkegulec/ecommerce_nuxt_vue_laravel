  ...
  <div class="navbar navbar-expand-lg navbar-light">
    ...
    <div class="navbar-collapse collapse" id="navbar-footer">
      <span class="navbar-text">
        ...
        <a href="https://themeforest.net/user/Kopyov" target="_blank">Eugene Kopyov</a>
      </span>
      ...
      <ul class="navbar-nav ml-lg-auto">
        ...
        <li class="nav-item">
          <a
            href="https://demo.interface.club/limitless/docs/"
            class="navbar-nav-link"
            target="_blank"
            ><i class="icon-file-text2 mr-2"></i> Docs</a
          >
        </li>
        <li class="nav-item">
          <a
            ...
            ><span class="text-pink"><i class="icon-cart2 mr-2"></i> Purchase</span></a
          >
        </li>
      </ul>
    </div>
